...
def plot_training_diagnostics(
    ...
    # 1) Defaults
    fig_kwargs = fig_kwargs or {"figsize": (14, 10), "gridspec_kw": {"height_ratios": [3, 2, 0.5]}}
    ...
    box_style = {"boxstyle": "round,pad=0.16", "fc": "white", "ec": "white", "lw": 0.8, "alpha": 0.4}
    ax_loss.text(
        0.02,
        0.95,
        subplot_labels[0],
    ...
    for idx, tag in enumerate(loss_tags):
        ...
        for exp, vers in experiments.items():
            for i, v in enumerate(vers):
                ...
                steps, vals, epochs = load_fn(logdir, tag, epoch_length=epoch_length, offset=None)
